import { BOOKINGS_TABLE, PAGE_SIZE, SORT_ASC } from "../constant";
...
export async function getStaysTodayActivity() {
  ...
  // actually need, otherwise we would need ALL bookings ever created, before processing
