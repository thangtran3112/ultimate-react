...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      'text-sm px-4 py-2.5 md:px-6 md:py-3.5 border-2 border-stone-300 inline-block rounded-full ' +
      'font-semibold uppercase tracking-wide text-stone-400 transition-colors hover:text-stone-300 ' +
      'duration-300 hover:bg-stone-800 focus:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring ' +
